  ...
  return (
    <section className="py-24 sm:py-32 bg-nb-off-white dark:bg-nb-black relative border-b border-black/10 dark:border-white/10">
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <div className="p-8 sm:p-12 rounded-3xl bg-nb-white dark:bg-nb-soft-black border border-black/10 dark:border-white/10 shadow-sm relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            {/* Left: Origin & Engineering Culture */}
            <div className="lg:col-span-6 space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-black/5 dark:bg-white/10 text-xs font-mono-tech text-nb-black dark:text-nb-off-white">
                <Radio className="w-3.5 h-3.5 text-nb-orange animate-pulse" />
                <span>ORIGIN POINT // INDIA</span>
              </div>

              <h3 className="text-2xl sm:text-3xl font-bold text-nb-black dark:text-nb-white tracking-tight leading-tight">
                Global engineering rigor with international communication standards.
              </h3>

              <p className="text-sm sm:text-base text-nb-graphite dark:text-nb-muted leading-relaxed">
              ...
              <div className="pt-2 grid grid-cols-2 gap-4 font-mono-tech text-xs">
                <div className="p-3.5 rounded-xl bg-nb-off-white dark:bg-white/5 border border-black/5 dark:border-white/5">
                  <span className="text-nb-muted block text-[10px]">DEPLOYMENT REGIONS</span>
                  <span className="font-bold text-nb-black dark:text-nb-off-white">Worldwide Edge CDN</span>
                </div>
                <div className="p-3.5 rounded-xl bg-nb-off-white dark:bg-white/5 border border-black/5 dark:border-white/5">
                  <span className="text-nb-muted block text-[10px]">COMMUNICATION</span>
                  <span className="font-bold text-nb-black dark:text-nb-off-white">International English</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 space-y-3">
              {REGIONS.map((r, i) => (
                <div
                  key={r.name}
                  className="p-4 rounded-xl bg-nb-off-white dark:bg-white/5 border border-black/5 dark:border-white/5 hover:border-nb-orange/40 transition-colors flex items-center justify-between font-mono-tech text-xs group"
                >
                  <div className="flex items-center gap-3">
                    <span className="text-nb-orange font-bold">0{i + 1}</span>
                    <span className="font-semibold text-nb-black dark:text-nb-off-white">{r.name}</span>
                  </div>
