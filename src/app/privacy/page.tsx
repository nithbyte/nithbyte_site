  ...
  return (
    <div className="pt-32 pb-24 max-w-4xl mx-auto px-6 sm:px-8 space-y-12">
      <div className="space-y-4 border-b border-black/10 pb-8">
        ...
        <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-nb-black">
          Privacy Policy
        </h1>
      ...
      <div className="space-y-8 text-sm sm:text-base text-nb-graphite leading-relaxed">
        <section className="space-y-3">
          <h2 className="text-xl font-bold text-nb-black font-display">1. Information Collection</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-bold text-nb-black font-display">2. Use of Information</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-bold text-nb-black font-display">3. Cookies and Analytics</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-bold text-nb-black font-display">4. Inquiries & Data Rights</h2>
          <p>
