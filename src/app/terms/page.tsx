    ...
    <div className="pt-32 pb-24 max-w-4xl mx-auto px-6 sm:px-8 space-y-12">
      ...
      <div className="space-y-8 text-sm sm:text-base text-nb-graphite leading-relaxed">
        <section className="space-y-3">
          <h2 className="text-xl font-bold text-nb-black font-display">1. Acceptance of Terms</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-bold text-nb-black font-display">2. Intellectual Property</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-bold text-nb-black font-display">3. Project Engagements</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-bold text-nb-black font-display">4. Contact & Inquiries</h2>
          <p>
